...
@Entity
@Table(name="conf_restricao_grupo")
public class RestricaoGrupo implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private RestricaoGrupoPK id;
	...
	public RestricaoGrupoPK getId() {
		return id;
	}

	public void setId(RestricaoGrupoPK id) {
		this.id = id;
	}
