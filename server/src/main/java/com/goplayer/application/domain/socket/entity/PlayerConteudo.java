...
@Entity
@Table(name="soc_player_conteudo")
public class PlayerConteudo implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private PlayerConteudoPK id;
	...
	public PlayerConteudoPK getId() {
		return id;
	}

	public void setId(PlayerConteudoPK id) {
		this.id = id;
	}
