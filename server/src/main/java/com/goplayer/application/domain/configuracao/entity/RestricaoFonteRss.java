...
@Entity
@Table(name="conf_restricao_fonterss")
public class RestricaoFonteRss implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private RestricaoFonteRssPK id;
	...
	public RestricaoFonteRssPK getId() {
		return id;
	}

	public void setId(RestricaoFonteRssPK id) {
		this.id = id;
	}
