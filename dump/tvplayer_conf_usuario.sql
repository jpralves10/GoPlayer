...
CREATE TABLE `conf_usuario` (
  ...
  `cd_restricao` varchar(6) DEFAULT NULL,
  `de_senha` varchar(32) DEFAULT NULL,
  `de_token` varchar(32) DEFAULT NULL,
  `cd_usuario_atualizacao` varchar(20) DEFAULT NULL,
  `dt_atualizacao` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`cd_empresa`,`cd_usuario`,`de_email`,`cd_perfil`)
