...
--
-- Table structure for table `not_fonterss_campos`
--

DROP TABLE IF EXISTS `not_fonterss_campos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `not_fonterss_campos` (
  ...
  PRIMARY KEY (`cd_empresa`,`cd_fonterss`,`cd_campo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `not_fonterss_campos`
--

LOCK TABLES `not_fonterss_campos` WRITE;
/*!40000 ALTER TABLE `not_fonterss_campos` DISABLE KEYS */;
/*!40000 ALTER TABLE `not_fonterss_campos` ENABLE KEYS */;
UNLOCK TABLES;
